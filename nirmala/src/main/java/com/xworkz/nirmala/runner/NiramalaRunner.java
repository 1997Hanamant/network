...
public class NiramalaRunner {
	...
	public static void main(String[] args) {
		NirmalaEntity entity = new NirmalaEntity("BTM", "Male", "Public", 10.00D, LocalTime.now(), "Muttu",
				LocalDate.now(), "Ravi", LocalDate.now());
		NirmalaEntity entity1 = new NirmalaEntity("RR Nagar", "Male", "Private", 10.00D, LocalTime.now(), "Charana",
				LocalDate.now(), "Suhas", LocalDate.now());
		NirmalaEntity entity2 = new NirmalaEntity("JR Nagar", "Female", "Private", 10.00D, LocalTime.now(), "Prajawal",
				LocalDate.now(), "DP", LocalDate.now());
		NirmalaEntity entity3 = new NirmalaEntity("VR Nagar", "Female", "Private", 20.00D, LocalTime.now(), "Hanamant",
				LocalDate.now(), "Basavaraj", LocalDate.now());
		NirmalaEntity entity4 = new NirmalaEntity("RJ Nagar", "Male", "Public", 5.00D, LocalTime.now(), "Sachin",
